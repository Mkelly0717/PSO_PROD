--------------------------------------------------------
--  DDL for Procedure U_60_PST_REPLENISHMENTS_BACKUP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "SCPOMGR"."U_60_PST_REPLENISHMENTS_BACKUP" as
v_ohpost date;
begin
...
from 
  ...
  case when  o.u_sales_document = 'Z1BA' then 'US99' else o.loc end dest,
  case when  o.u_sales_document = 'Z1BA' then o.loc else 'US99' end source,
