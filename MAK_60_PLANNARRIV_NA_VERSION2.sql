--------------------------------------------------------
--  DDL for View MAK_60_PLANNARRIV_NA_VERSION2
--------------------------------------------------------

  CREATE OR REPLACE VIEW "SCPOMGR"."MAK_60_PLANNARRIV_NA_VERSION2" ("ITEM", "DEST", "DESCR", "CITY", "STATE", "POSTALCODE", "U_CUSTORDERID", "LOADID", "SOURCE", "DESCR_SOURCE", "CITY_SOURCE", "STATE_SOURCE", "PC_SOURCE", "SOURCING", "RPA", "TRANSIT_TIME", "SCHEDSHIPDATE", "SCHEDARRIVDATE", "QTY") AS 
  SELECT p.item,
    p.dest,
    ld.descr,
    ld.u_city city,
