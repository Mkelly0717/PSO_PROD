--------------------------------------------------------
--  DDL for View MAK_SM_VIEW_TBDELETED
--------------------------------------------------------

  CREATE OR REPLACE VIEW "SCPOMGR"."MAK_SM_VIEW_TBDELETED" ("RECNUM", "SOURCING", "ITEM", "DEST", "SOURCE", "EFF", "SM_TOTQTY", "CUST_TOTQTY", "DIFF_SM_ALL", "ORDER_QTY", "VLL_QTY", "REMAINDER", "VLLQTY_PROCESSED", "COQTY_PROCESSED", "DUR", "CATEGORY", "QTYUOM", "LOC_TYPE_SRC", "LOC_TYPE_DEST") AS 
