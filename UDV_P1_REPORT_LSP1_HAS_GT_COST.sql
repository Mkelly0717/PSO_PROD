--------------------------------------------------------
--  DDL for View UDV_P1_REPORT_LSP1_HAS_GT_COST
--------------------------------------------------------

  CREATE OR REPLACE VIEW "SCPOMGR"."UDV_P1_REPORT_LSP1_HAS_GT_COST" ("LS_ITEM", "LS_DEST", "LS_DEST_PC", "LS_SRC", "LS_SOURCE_PC", "LS_ET", "LS_QTY", "LS_RANK", "LS_LLAMA_P1", "LS_COST", "SMR1_RANK", "SMR1_LLAMA_P1", "SMR1_SRC", "SMR1_SOURCE_PC", "SMR1_QTY", "SMR1_COST", "SMR1_TOTALCOST", "LS_TOTALCOST", "SAVINGS") AS 
