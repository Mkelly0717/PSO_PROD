--------------------------------------------------------
--  DDL for View UDV_PE_PERCENT_MET_ARRIVDT
--------------------------------------------------------

  CREATE OR REPLACE VIEW "SCPOMGR"."UDV_PE_PERCENT_MET_ARRIVDT" ("SHIPDATE", "CO_CNT", "PA_CNT", "CO_QTY", "PA_QTY", "DEL_CNT", "PD_CNT", "DEL_QTY", "PD_QTY", "%CO_MET", "%CO_QTY_MET", "%DEL_MET", "%DELQTY_MET") AS 
  with co_orders as
