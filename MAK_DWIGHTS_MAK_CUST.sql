...
--------------------------------------------------------
  ...
  , ld.u_city as d_city                                , ld.u_state as d_state    , ls.postalcode source_pc,
    ...
    mct.assigned_plant, mct.loc ), null ) initial_cost
    , p1
     from mak_cust_table mct, loc ld, loc ls, costtier ctier
