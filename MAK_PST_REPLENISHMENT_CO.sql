  CREATE OR REPLACE PROCEDURE "SCPOMGR"."MAK_PST_REPLENISHMENT_CO" AS 
v_qty number;
BEGIN
...
insert into TMP_SOURCINGMETRIC_NA
     ...
     from sim_sourcingmetric s,  custorder o, vehicleloadline vll, custorder col, vehicleloadline vllcol
...
insert into TMP_SOURCINGMETRIC_NA
     ...
     from sim_sourcingmetric s, custorder o, vehicleloadline vll, scpomgr.TMP_SOURCINGMETRIC_NA t
     where substr(s.sourcing, 1, 7) <> 'MER9DEL'
     and s.category = 417
     and s.item= o.item
     and s.dest = o.loc
